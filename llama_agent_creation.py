...
# Simplified models for dictionary fields to avoid schema validation issues
...
class ASCFilings(BaseModel):
    ...
    # Changed from Dict to List of structured objects
    ...
    # Changed from List[Dict[str, str]] to List[FAQItem]
    frequently_asked_questions: List[FAQItem] = Field(
        default_factory=list,
